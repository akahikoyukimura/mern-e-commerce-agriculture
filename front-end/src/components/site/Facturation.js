  ...
  <div class="card-body">
    ...
    <div class="container">
      ...
      <div class="row text-center">
        <h3 class="text-uppercase text-center mt-3" style={{ fontSize: "40px" }}>Invoice</h3>
        <p>123456789</p>
      </div>
      ...
      <div class="row">
        <div class="col-xl-8">
          <ul class="list-unstyled float-end me-0">
            ...
            <li><span class="float-start" style={{ marginRight: "35px" }}>Shippment: </span><i
